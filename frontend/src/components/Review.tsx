...
const reviews = [
  {
    ...
    text: '정말 친절하게 자세히 설명해 주시고 무엇보다 신뢰와 믿음이 정말 갑니다. 차량 설명 등 고객에 맞는 차량 선택 및 차량의 장/단점 꼼꼼히 체크해 주십니다. 저의 부모님 지...',
    carImage: '/images/reviewcar1.png',
    price: '256,350원~'
  },
  {
    ...
    carImage: '/images/reviewcar2.jpg',
    price: '0원~'
  },
  {
    ...
    carImage: '/images/reviewcar3.png',
    price: '0원~'
  },
];
    ...
    <section className="bg-white w-full px-4 sm:px-8 py-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {reviews.map((r, idx) => (
            <div key={idx} className="bg-white rounded-xl shadow-sm overflow-hidden border">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 text-sm mb-4">{r.text}</p>
                <hr className="my-2" />
